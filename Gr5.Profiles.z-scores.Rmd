...
There seem to be 9 sizable clusters, along with several smaller ones. Let's look at how they differ:
...
I may well be imposing too much of my expectations on these. Only C8, C2, and C5 really seem to be "flat" with just variance in overall ability. Perhaps 6and 1.
\newpage
...
This seems to pick G2 as overall better than G1, but particularly on Kananaskis, and Earth.

\newpage

#### EEE, 2

For this model, the groups must have similar "sizes" in terms of the score space.
...
Seems to be showing a bit of different separations. Not just for ELA now, but also Earth.
