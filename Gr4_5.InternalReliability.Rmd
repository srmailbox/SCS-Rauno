...
However, not all of the Mazes appear to be unidimensional. In the table below, the omega total score is decomposed into reliability coming from a single "general" factor (omega_h) and a set of factors (omega_grp) (the rest is "specific reliability" and random error that can't be separated in this kind of data). A good unidimensional test has mostly "general" reliability, and relatively little "group" reliability.
...
However, decomposing omega into a single general factor or three factors suggests that not all of the Mazes appear to be unidimensional.
...
Understanding the nature of the multidimensionality in some of the Mazes would require a careful look a the factor loadings - and probably more work examining the factor structure more carefully (rather than just assuming 3 factors in all cases).